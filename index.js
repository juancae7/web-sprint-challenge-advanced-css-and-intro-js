...
for(let i=0; i < artists.length; i++){
  if(artists[i].name.includes("Vincent van Dough")){
    newArtists.splice(artists[i],1,"Vincent Van Gogh");
  }
}
...
console.log(removeArtist(name, 2));
